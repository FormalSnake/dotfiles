...
in
{
  programs.aerospace = {
    ...
    settings = {
      ...
      mode.main.binding = {
        # Vim-style focus (matches the g815 Hyprland SUPER+hjkl)
        alt-h = "focus left";
        alt-j = "focus down";
        alt-k = "focus up";
        alt-l = "focus right";
        ...
        # Vim-style move (matches the g815 Hyprland SUPER+SHIFT+hjkl)
        alt-shift-h = "move left";
        alt-shift-j = "move down";
        alt-shift-k = "move up";
        alt-shift-l = "move right";

        # Resize (matches the g815 Hyprland column-width binds)
